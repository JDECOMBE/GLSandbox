...
public class BatchMesh : IRenderingItem
{
    ...
    public void Init()
    {
        ...
        _instanceVbo.Bind();
        _vao.SetAttribPointer(2, 3, sizeof(float) * 8, IntPtr.Zero);
        _vao.SetAttribPointer(3, 3, sizeof(float) * 8, IntPtr.Zero + 3 * sizeof(float));
        _vao.SetAttribPointer(4, 1, sizeof(float) * 8, IntPtr.Zero + 6 * sizeof(float));
        _vao.SetAttribPointer(5, 1, sizeof(float) * 8, IntPtr.Zero + 7 * sizeof(float));
